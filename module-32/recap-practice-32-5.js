...
3.b: with two parameter. will add two to each number and then multiply the result.
3.c: three parameters. will multiply all three parameters
3.d: with two parameters but it will be a multi line arrow function. will add two to each number and them multiply the result.make sure you return the result
...
10. [optional] just a write a function with three parameters. and the last parameter will have a default parameter with value 7. this function wil take three parameters and will return the sum of all the three parameters.
*/